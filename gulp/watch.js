 ...
 * configuration settings for the Gulp watch functions. If you need to modify the Gulp
 * watch tasks and their usage, you should do so in the `gulpfile.babel.js` file in the root directory.
 * 
